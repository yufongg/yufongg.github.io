...
tags: [data-recovery]
image:
  src: Pasted%20image%2020220917002024.png
...
3. I tried to further enumerate the web directory for files that contain credentials, failed.
	```
	┌──(root💀kali)-[~/htb/mirai/10.10.10.48/loot]
...
2. Search exploits for `Plex Media Server`
	...
	- Tried some of the POC, did not work.
