...
4. Create `exploit.hcl` to execute our reverse shell
...
5. Reload `consul` to apply our configuration
...
3. Fix Error - [Source](https://juejin.cn/post/7148784966808109063)
