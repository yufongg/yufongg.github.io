...
info:
  ...
  difficulty: 2
img_path: /Writeups/CTF/GreyCTF%202025/Web/Oops/attachments/
image:
  src: ../../../../GreyCTF%202024/Web/Beautiful%20Styles/attachments/Beautiful%20Styles-20240510000105525.png
...
1. Verify that XSS is possible with an alert payload
	...
	![](Oops-1748770951108.png)

2. Visit the shortened URL 
	![](Oops-1748771091150.png)
...
5. Admin visits the URL, XSS executes and redirects to the attacker's site, appending the admin's cookie as a GET parameter
	![](Oops-1748770874645.png)

6. Solve

    <video muted autoplay controls style="width: 740px; height: 460px;">
        <source src="{{site.img_cdn}}{{page.img_path}}2025-06-01%2017-38-43.mp4" type="video/mp4">
    </video>
...
7. Solver
    ...
    <video muted autoplay controls style="width: 740px; height: 460px;">
        <source src="{{site.img_cdn}}{{page.img_path}}9zBitg5jVM.mp4" type="video/mp4">
    </video>